...
msh_file = 'D:\codes\gid\data_v3.msh'
#msh_file = 'D:\codes\gid\data_v2.msh'
#msh_file = 'D:\codes\gid\data_v4.msh'
#msh_file = 'D:\codes\gid\data_new.msh'
...
plt.scatter(x_disped[bottom_nodes, 0].numpy(), x_disped[bottom_nodes, 1].numpy(), c='red', s=10, zorder=10)  # 高亮显示底部节点
plt.scatter(x_disped[side_nodes_left, 0].numpy(), x_disped[side_nodes_left, 1].numpy(), c='red', s=10, zorder=10)  # 高亮显示左侧节点
plt.scatter(x_disped[side_nodes_right, 0].numpy(), x_disped[side_nodes_right, 1].numpy(), c='red', s=10, zorder=10)  # 高亮显示右侧节点
